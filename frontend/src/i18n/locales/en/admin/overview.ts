export default {
    ...
    groups: {
      ...
      modelRouting: {
        title: 'Model Routing',
        tooltip: 'Configure specific model requests to be routed to designated accounts. Supports wildcard matching, e.g., claude-opus-*, gpt-4o*, sol*.',
        enabled: 'Enabled',
        disabled: 'Disabled',
        disabledHint: 'Routing rules will only take effect when enabled',
        addRule: 'Add Routing Rule',
        modelPattern: 'Model Pattern',
        modelPatternPlaceholder: 'e.g., claude-opus-* or gpt-4o*, sol*',
        modelPatternHint: 'Supports * wildcard, e.g., claude-*, gpt-4o*, sol*',
